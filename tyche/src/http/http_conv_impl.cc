...
namespace tyche::http {
    [[maybe_unused]] const char* get_code_message(uint16_t code) {
        switch (code) {
#pragma region Http Code 1xx - Informational
...
#pragma region Http Code 2xx - Successful
        case 200: return "OK";
...
#pragma region Http Code 3xx - Redirection
...
#pragma region Http Code 4xx - Client Error
...
#pragma region Http Code 5xx - Server Error
